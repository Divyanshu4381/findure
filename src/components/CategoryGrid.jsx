...
const categories = [
  ...
  { title: 'Car rental', icon: require('../assets/icons/car.png') },
  { title: 'Beauty', icon: require('../assets/icons/beauty.png') },
  { title: 'Wedding planners', icon: require('../assets/icons/wedding.webp') },
  ...
  { title: 'Rent and Hire', icon: require('../assets/icons/rent.png') },
  { title: 'Jobs', icon: require('../assets/icons/jobs.png') },
  { title: 'Emergency', icon: require('../assets/icons/emergency-call.png') },
];
